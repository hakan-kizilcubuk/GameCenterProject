    ...
    public partial class AddIdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CartRatings_Carts_CartId",
                        column: x => x.CartId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LibraryUserId = table.Column<string>(type: "nvarchar(128)", nullable: false),
                    GameId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryGames", x => new { x.LibraryUserId, x.GameId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LibraryGames_Libraries_LibraryUserId",
